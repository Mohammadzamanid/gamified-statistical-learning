...
**5 of 22 topics** meet §4: at least 100 validated available interactions spanning at least 4 reasoning families, with nothing unreachable.
...
| Addition (`skill.r1-addition`) | 7 | 8 | 7 | 800 | 800 | 720 | **727** | Yes |
| Cases and observations (`skill.r1-cases`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Coordinates (`skill.r1-coordinates`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Counting (`skill.r1-counting`) | 7 | 8 | 8 | 1000 | 848 | 789 | **796** | Yes |
| Decimals (`skill.r1-decimals`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Division (`skill.r1-division`) | 7 | 8 | 6 | 800 | 301 | 284 | **291** | Yes |
| Fractions (`skill.r1-fractions`) | 8 | 0 | 0 | 0 | 0 | 0 | **8** | **No** |
| Multiplication (`skill.r1-multiplication`) | 7 | 8 | 7 | 800 | 761 | 681 | **688** | Yes |
| Negative numbers (`skill.r1-negatives`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Number lines (`skill.r1-number-lines`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Percentages (`skill.r1-percentages`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Proportions (`skill.r1-proportions`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Ratios (`skill.r1-ratios`) | 7 | 0 | 0 | 0 | 0 | 0 | **7** | **No** |
| Subtraction (`skill.r1-subtraction`) | 7 | 8 | 8 | 800 | 797 | 718 | **725** | Yes |
...
| Addition | 0 | 0 | 0 | 0 | 0 | 80 | 0 | 0 | 11% |
| Cases and observations | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Coordinates | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Counting | 152 | 0 | 0 | 0 | 0 | 59 | 0 | 0 | 13% |
| Decimals | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Division | 499 | 0 | 0 | 0 | 0 | 4 | 13 | 0 | 13% |
| Fractions | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 13% |
| Multiplication | 39 | 0 | 0 | 0 | 0 | 80 | 0 | 0 | 12% |
| Negative numbers | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Number lines | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Percentages | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Proportions | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Ratios | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 0 | 14% |
| Subtraction | 3 | 0 | 0 | 0 | 0 | 79 | 0 | 0 | 11% |
...
- **Mean** — 0: _none_
- **Median** — 0: _none_
- **Addition** — 7: Calculation · Comparison · Error identification · Irrelevant-information filtering · Multi-step reasoning · Real-world application · Recognition
...
- **Fractions** — 0: _none_
- **Multiplication** — 7: Calculation · Comparison · Error identification · Irrelevant-information filtering · Multi-step reasoning · Real-world application · Recognition
- **Negative numbers** — 0: _none_
- **Number lines** — 0: _none_
- **Percentages** — 0: _none_
- **Proportions** — 0: _none_
- **Ratios** — 0: _none_
...
- **Coordinates** (`skill.r1-coordinates`)
  ...
  - 7 available interactions, below the required 100
  - 0 reasoning families represented, below the required 4
- **Decimals** (`skill.r1-decimals`)
  - no generator families produce for this topic
  - 7 available interactions, below the required 100
  - 0 reasoning families represented, below the required 4
- **Fractions** (`skill.r1-fractions`)
  - no generator families produce for this topic
...
- **Number lines** (`skill.r1-number-lines`)
  ...
  - 7 available interactions, below the required 100
  - 0 reasoning families represented, below the required 4
- **Percentages** (`skill.r1-percentages`)
  - no generator families produce for this topic
  - 7 available interactions, below the required 100
  - 0 reasoning families represented, below the required 4
- **Proportions** (`skill.r1-proportions`)
  - no generator families produce for this topic
  - 7 available interactions, below the required 100
  - 0 reasoning families represented, below the required 4
